...
class DomProcessor {
    ...
    _processUrlAttrs(el, urlReplacer, pattern) {
        ...
        const isSpecialPageUrl = url_1.isSpecialPage(resourceUrl);
        ...
        if (isIframe && !isSpecialPageUrl && !isRelativePath)
            isCrossDomainSrc = !this.adapter.sameOriginCheck(url_1.parseProxyUrl(urlReplacer('/')).destUrl, resourceUrl);
