...
const transformer = {
    ...
    condition: (node, parent) => {
        ...
        if (parent.type === esotope_hammerhead_1.Syntax.ForInStatement)
            return false;
    ...
    run: (node) => {
        const declarations = [];
        for (const declarator of node.declarations) {
            destructuring_1.default(declarator.id, declarator.init, (pattern, value) => declarations.push(node_builder_1.createVariableDeclarator(pattern, value)));
        }
