...
exports.requestTransforms = {
    ...
    [builtin_header_names_1.default.referer]: (_src, ctx) => ctx.dest.referer || void 0,
...
exports.responseTransforms = {
    ...
    [builtin_header_names_1.default.contentType]: (src, ctx) => ctx.contentInfo.isIframeWithImageSrc ? 'text/html' : src,
